...
main(void)
{
  ...
  14:	88850513          	addi	a0,a0,-1912 # 898 <malloc+0xe8>
  18:	00000097          	auipc	ra,0x0
  1c:	3aa080e7          	jalr	938(ra) # 3c2 <mknod>

  if(open("console", O_RDWR) < 0){
  20:	4589                	li	a1,2
  22:	00001517          	auipc	a0,0x1
  26:	87e50513          	addi	a0,a0,-1922 # 8a0 <malloc+0xf0>
  2a:	00000097          	auipc	ra,0x0
  2e:	390080e7          	jalr	912(ra) # 3ba <open>
  ...
  3c:	3ba080e7          	jalr	954(ra) # 3f2 <dup>
  dup(0);  // stderr
  40:	4501                	li	a0,0
  42:	00000097          	auipc	ra,0x0
  46:	3b0080e7          	jalr	944(ra) # 3f2 <dup>

  for(;;){
    printf("init: starting sh\n");
  4a:	00001917          	auipc	s2,0x1
  4e:	85e90913          	addi	s2,s2,-1954 # 8a8 <malloc+0xf8>
  52:	854a                	mv	a0,s2
  54:	00000097          	auipc	ra,0x0
  58:	69e080e7          	jalr	1694(ra) # 6f2 <printf>
    pid = fork();
  5c:	00000097          	auipc	ra,0x0
  60:	316080e7          	jalr	790(ra) # 372 <fork>
  64:	84aa                	mv	s1,a0
    if(pid < 0){
  66:	04054d63          	bltz	a0,c0 <main+0xc0>
      printf("init: fork failed\n");
      exit(1);
    }
    if(pid == 0){
  6a:	c925                	beqz	a0,da <main+0xda>
    }
  ...
  72:	314080e7          	jalr	788(ra) # 382 <wait>
      if(wpid == pid){
  76:	fca48ee3          	beq	s1,a0,52 <main+0x52>
        // the shell exited; restart it.
        break;
      } else if(wpid < 0){
  7a:	fe0559e3          	bgez	a0,6c <main+0x6c>
        printf("init: wait returned an error\n");
  7e:	00001517          	auipc	a0,0x1
  82:	87a50513          	addi	a0,a0,-1926 # 8f8 <malloc+0x148>
  86:	00000097          	auipc	ra,0x0
  8a:	66c080e7          	jalr	1644(ra) # 6f2 <printf>
        exit(1);
  8e:	4505                	li	a0,1
  ...
  a0:	80450513          	addi	a0,a0,-2044 # 8a0 <malloc+0xf0>
  a4:	00000097          	auipc	ra,0x0
  a8:	31e080e7          	jalr	798(ra) # 3c2 <mknod>
    open("console", O_RDWR);
  ac:	4589                	li	a1,2
  ae:	00000517          	auipc	a0,0x0
  b2:	7f250513          	addi	a0,a0,2034 # 8a0 <malloc+0xf0>
  b6:	00000097          	auipc	ra,0x0
  ba:	304080e7          	jalr	772(ra) # 3ba <open>
  be:	bfa5                	j	36 <main+0x36>
      printf("init: fork failed\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	80050513          	addi	a0,a0,-2048 # 8c0 <malloc+0x110>
  ...
  de:	85e58593          	addi	a1,a1,-1954 # 938 <argv>
  e2:	00000517          	auipc	a0,0x0
  e6:	7f650513          	addi	a0,a0,2038 # 8d8 <malloc+0x128>
  ea:	00000097          	auipc	ra,0x0
  ee:	2c8080e7          	jalr	712(ra) # 3b2 <exec>
      printf("init: exec sh failed\n");
  f2:	00000517          	auipc	a0,0x0
  f6:	7ee50513          	addi	a0,a0,2030 # 8e0 <malloc+0x130>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 462:	4c250513          	addi	a0,a0,1218 # 920 <digits>
 466:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 52e:	3f6b8b93          	addi	s7,s7,1014 # 920 <digits>
 ...
 66e:	2ae90913          	addi	s2,s2,686 # 918 <malloc+0x168>
        while(*s != 0){
 ...
 764:	00e6ea63          	bltu	a3,a4,778 <free+0x50>
{
 ...
 7a6:	1af73323          	sd	a5,422(a4) # 948 <freep>
}
 7aa:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7d8:	17453503          	ld	a0,372(a0) # 948 <freep>
 ...
 800:	14c90913          	addi	s2,s2,332 # 948 <freep>
  if(p == (char*)-1)
 804:	5afd                	li	s5,-1
 806:	a895                	j	87a <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 808:	00000797          	auipc	a5,0x0
 80c:	14878793          	addi	a5,a5,328 # 950 <base>
 810:	00000717          	auipc	a4,0x0
 814:	12f73c23          	sd	a5,312(a4) # 948 <freep>
 818:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 83c:	10a73823          	sd	a0,272(a4) # 948 <freep>
      return (void*)(p + 1);
 ...
 868:	ec4080e7          	jalr	-316(ra) # 728 <free>
  return freep;
